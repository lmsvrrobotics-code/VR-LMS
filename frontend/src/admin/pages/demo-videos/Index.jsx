        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        <h1 className="m-0 text-[18px] font-bold text-dark">Demo Videos</h1>
                        <p className="m-0 mt-0.5 text-[12px] text-gray">Intro/teaser videos shown to students above their courses.</p>
                    </div>
                </div>
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button type="button" className="inline-flex items-center gap-1.5 rounded-ol-8 bg-skin px-3.5 py-2 text-[13px] font-semibold text-white transition-colors hover:bg-skin-dark" onClick={() => setAddOpen(true)}>
                        <Plus className="h-4 w-4" /> Add Demo Video
                    </button>
                </div>
            </div>
                    ...
                    {isEmpty ? (
                        <div className="rounded-ol-8 border border-dashed border-ebordermuted bg-white py-16 text-center">
                            ...
                            <p className="mb-1 text-[15px] font-semibold text-dark">{query.search ? 'No videos match your search' : 'No demo videos yet'}</p>
                            <p className="text-[13px] text-gray">{query.search ? 'Try a different title.' : 'Click “Add Demo Video” to upload the first one.'}</p>
                        </div>
                    ) : (
                        <>
